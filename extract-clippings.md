...
# Usage: python extract-clippings.py -i "My Clippings.txt" -b "路遥全集" -o "平凡的世界" -a "路遥" -t "2020-09 ~ 10"
...
def get_opt():
    ...
    group.add_argument("-i", "--input", help="input clipping file's name", required=True)
